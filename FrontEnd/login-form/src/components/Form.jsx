...
function Form() {
    ...
    const check = () => {
        const loginDetails = axios.get(`http://localhost:5050?username=${uname}&password=${pass}`)
        // const loginDetails = axios.post("http://localhost:5050", { "username": uname, "password": pass })
